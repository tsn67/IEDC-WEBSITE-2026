...
function useExecomData() {
    ...
    const group3: Lead[] = [{ name: 'Abhiraman A V', imgeUrl: grp12, position: "Marketing Lead" }, { name: 'Karthika Satheesh', imgeUrl: grp32, position: 'Creative Amd Innovation Lead' }, { name: 'Meenakshi R', imgeUrl: grp33, position: 'Social Media Administrator' }, { name: 'Arathi V M', imgeUrl: grp21, position: 'IPR & Research Lead.' }]
    const group4: Lead[] = [{ name: 'Najma Nargis P T', imgeUrl: grp41, position: 'Women Enterpreneurship' }, { name: 'Sahala Yasmeen', imgeUrl: grp43, position: 'Branding Lead' }, { name: 'Sourav Surendran', imgeUrl: grp44, position: 'Video Design Lead' }, { name: 'Devika Sudheer', imgeUrl: grp22, position: 'Technology Lead' },]
