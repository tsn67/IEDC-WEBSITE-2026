...
const RightTab = () => {
    ...
    const rightBarContent: Word[] = [{ color: '#6C17AE', content: 'Innovation' }, { color: '#5779FF', content: 'Entrepreneurship', needAnd: true }, { color: '#FC0150', content: 'Development', }, { color: 'oklch(69.6% 0.17 162.48)', content: 'Center' }]
